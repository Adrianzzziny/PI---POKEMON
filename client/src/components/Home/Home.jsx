        ...
        <div className={styles.background}>
            <div className={styles.contentPadre}>
                ...
                <div className={styles.filters}>
                    ...
                    <label className={styles.labels}>ORDENAR POR NOMBRE
                    ...
                    <label className={styles.labels}>ORDENAR POR FUERZA
                    ...
                    <label className={styles.labels}>TIPOS
                ...
                <div className={styles.containerPokemon}>
                    {//mapeo el estado global y le paso cada una de las props que necesita mi card
