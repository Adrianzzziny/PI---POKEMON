...
import styles from '../SearchBar/SearchBar.module.css';
  ...
  function SearchBar() {
    ...
    let [name, setName] = useState("");//me creo un estado local
      ...
      e.preventDefault()
        // Despacho la accion
      dispatch(getByName(name))//este name va a ser mi estado local. Voy a ir guardando
        //lo que esta tipiando el usuario en mi estado local name.Entonces lo que yo tengo en mi estado local
        //derrepente, va a llegarle despues a mi accion, que va a llamar al back y le va a pasar esto
        //(lo que esta escribiendo el usuario)
      setName('')
      }
  return(
